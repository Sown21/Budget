    ...
    return (
        <div className="rounded-lg shadow overflow-hidden mx-8 my-8">
            <div className="max-h-96 overflow-auto pb-10">
                ...
                <tbody>
                    {data.map((spent, idx) => {
                        const isModifying = idToModify && spent.id === idToModify;
                        return (
                            <tr
                                key={spent.id}
                                className={
                                    `${isModifying ? "bg-blue-300 animate-pulse" : idx % 2 === 0 ? "bg-gray-100 hover:bg-gray-200" : "bg-blue-100 hover:bg-blue-200"}`
                                }
                            >
