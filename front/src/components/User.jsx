...
const User = ({ user, onDeleteClick }) => {
    ...
    return (
        <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-xl hover:scale-105 hover:shadow-lg transition-all duration-200 min-h-[200px] flex flex-col items-center">
